 ...
 public static void main(String[] args)throws Exception{
  ...
  try {
   ...
   try{
    ...
    String body="csrf=fixture-token&action=ticket&type=COMPLAINT&subject=Fixture+complaint&description=Please+investigate";
    ...
    NotificationWorkflowTest.regression();
