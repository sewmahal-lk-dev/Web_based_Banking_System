...
public class CustomerServicesServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req,HttpServletResponse res) throws ServletException,IOException {
        ...
        try {
            ...
            switch(section) {
                ...
                case "tickets" -> {
                    switch(Input.choice(action,"ticket","ticket-update","ticket-close","ticket-reply")) {
                        ...
                        case "ticket" -> dao.ticket(id,req.getParameter("type"),req.getParameter("subject"),req.getParameter("description"),req.getParameter("priority"));
            ...
            req.getSession().setAttribute("flash","ticket".equals(action)&&"COMPLAINT".equals(req.getParameter("type"))?"Your complaint was submitted successfully. Track its status and replies in your support history.":"Your changes were saved successfully.");
