...
public class CustomerServicesDAO {
    ...
    public void ticket(int customerId,String type,String subject,String description,String priority) throws SQLException {
        final String urgency=Input.choice(priority==null?"MEDIUM":priority,"LOW","MEDIUM","HIGH","URGENT");
        final String category=Input.choice(type,"INQUIRY","COMPLAINT","TECHNICAL","OTHER");
        if("COMPLAINT".equals(category))Input.choice(urgency,"LOW","MEDIUM","HIGH");
