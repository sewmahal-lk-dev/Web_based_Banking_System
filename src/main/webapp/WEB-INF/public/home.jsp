                ...
                <div class="hero-bottom">
                    <div class="wrap hero-bottom-inner">
                        <div class="trust-feature">
                            <svg viewBox="0 0 32 32" aria-hidden="true"><path d="M16 3 27 7v9c0 6-5 10-11 13C10 26 5 22 5 16V7Z"/><path d="m11 15 4 4 7-8"/></svg>
                            <div><strong>Secure &amp; Reliable</strong><small>Everyday banking, with confidence</small></div>
                        </div>
                        <div class="trust-feature">
                            <svg viewBox="0 0 32 32" aria-hidden="true"><circle cx="16" cy="10" r="5"/><path d="M6 28v-3a10 10 0 0 1 20 0v3M24 5l2 2 4-4"/></svg>
                            <div><strong>Personalized Solutions</strong><small>Banking built around you</small></div>
                        </div>
                        <div class="trust-feature">
                            <svg viewBox="0 0 32 32" aria-hidden="true"><path d="M4 5v23h24M8 21l7-8 5 4 9-12M22 5h7v7"/></svg>
                            <div><strong>Grow Your Wealth</strong><small>Make room for your ambitions</small></div>
                        </div>
                        <div class="trust-feature">
                            <svg viewBox="0 0 32 32" aria-hidden="true"><path d="M3 24h26M8 24a8 8 0 0 1 16 0M16 3v5M4 11l4 4M28 11l-4 4M8 29h16"/></svg>
                            <div><strong>A Brighter Tomorrow</strong><small>Your next chapter starts here</small></div>
                        </div>
                    </div>
                    <a class="hero-explore" href="#personal">Explore LankaTrust &darr;</a>
                </div>
